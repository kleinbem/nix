...
echo ""
echo "Instructions:"
echo "1. Run 'cd kleinbem-secrets && sops nix/per-host/nixos-nvme.yaml'"
echo "   (langfuse_*/n8n_encryption_key/openwebui_secret_key all live in nixos-nvme's"
echo "   own scope, not a shared file)"
