...
tar czf "$TARBALL" \
  ...
  nix-config/ nix-presets/ nix-devshells/ nix-hardware/ nix-packages/ nix-templates/ nix-secrets/ scripts/
...
adb shell "
  ...
  bash \$HOME_DIR/scripts/phone-activate.sh
"
